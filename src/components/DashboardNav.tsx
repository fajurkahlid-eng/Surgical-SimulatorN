      ...
      <div className="container-page app-nav-bar flex items-center justify-between gap-4 h-full">
        ...
        <ul className="nav-links flex items-center gap-4 text-sm shrink min-w-0">
          ...
          {user?.role === 'instructor' && (
            <li className="shrink-0"><Link to="/instructor-dashboard" className="text-teal-300 hover:text-teal-100 transition py-1 whitespace-nowrap">{String(t('nav.instructorDashboard'))}</Link></li>
          )}
