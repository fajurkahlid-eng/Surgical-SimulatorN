...
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-MI3HLSF2.mjs
...
function readFlowCollection(state, nodeIndent) {
	var readNext = true, _line, _lineStart, _pos, _tag = state.tag, _result, _anchor = state.anchor, following, terminator, isPair, isExplicitPair, isMapping, overridableKeys = /* @__PURE__ */ Object.create(null), keyNode, keyTag, valueNode, ch = state.input.charCodeAt(state.position);
	if (ch === 91) {
		terminator = 93;
		isMapping = false;
		_result = [];
...
function testImplicitResolving(state, str2) {
	...
	for (index = 0, length = state.implicitTypes.length; index < length; index += 1) {
		...
		if (type2.resolve(str2)) return true;
	}
	return false;
}
...
function detectType(state, object, explicit) {
	var _result, typeList = explicit ? state.explicitTypes : state.implicitTypes, index, length, type2, style;
	for (index = 0, length = typeList.length; index < length; index += 1) {
		...
		if ((type2.instanceOf || type2.predicate) && (!type2.instanceOf || typeof object === "object" && object instanceof type2.instanceOf) && (!type2.predicate || type2.predicate(object))) {
			...
			if (type2.represent) {
				...
				else throw new exception("!<" + type2.tag + "> tag resolver accepts not \"" + style + "\" style");
				state.dump = _result;
			}
			return true;
		}
...
//# sourceMappingURL=chunk-MI3HLSF2-DHQ3pTGf.js.map