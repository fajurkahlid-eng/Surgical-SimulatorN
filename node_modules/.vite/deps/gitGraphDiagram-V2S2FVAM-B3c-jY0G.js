...
import { B as setAccTitle, C as getDiagramTitle, K as setupGraphViewbox2, U as setDiagramTitle, _ as getAccDescription, a as clear, b as getConfig2, d as defaultConfig_default, s as common_default, v as getAccTitle, y as getConfig, z as setAccDescription } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { h as utils_default, p as random, r as cleanAndMerge } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
...
//#region node_modules/mermaid/dist/chunks/mermaid.core/gitGraphDiagram-V2S2FVAM.mjs
var commitType = {
	NORMAL: 0,
	REVERSE: 1,
	HIGHLIGHT: 2,
...
var DEFAULT_GITGRAPH_CONFIG2 = getConfig2()?.gitGraph;
...
var drawCommitBullet = /* @__PURE__ */ __name((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
	if (commitSymbolType === commitType.HIGHLIGHT) {
		...
		if (commitSymbolType === commitType.REVERSE) gBullets.append("path").attr("d", `M ${commitPosition.x - 5},${commitPosition.y - 5}L${commitPosition.x + 5},${commitPosition.y + 5}M${commitPosition.x - 5},${commitPosition.y + 5}L${commitPosition.x + 5},${commitPosition.y - 5}`).attr("class", `commit ${typeClass} ${commit2.id} commit${branchIndex % THEME_COLOR_LIMIT}`);
	}
}, "drawCommitBullet");
var drawCommitLabel = /* @__PURE__ */ __name((gLabels, commit2, commitPosition, pos) => {
	if (commit2.type !== commitType.CHERRY_PICK && (commit2.customId && commit2.type === commitType.MERGE || commit2.type !== commitType.MERGE) && DEFAULT_GITGRAPH_CONFIG2?.showCommitLabel) {
		...
		if (bbox) {
			...
			if (DEFAULT_GITGRAPH_CONFIG2.rotateCommitLabel) if (dir === "TB" || dir === "BT") {
...
var diagram = {
	...
	renderer: { draw: /* @__PURE__ */ __name(function(txt, id, ver, diagObj) {
		...
		setupGraphViewbox2(void 0, diagram2, DEFAULT_GITGRAPH_CONFIG2.diagramPadding, DEFAULT_GITGRAPH_CONFIG2.useMaxWidth);
	}, "draw") },
...
//# sourceMappingURL=gitGraphDiagram-V2S2FVAM-B3c-jY0G.js.map