import { B as select_default, H as __name, U as log } from "./src-B_PPPpSz.js";
...
import { f as parseFontSize, h as utils_default } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-MI3HLSF2-DHQ3pTGf.js";
import { t as require_dist } from "./dist-BmpuAFl_.js";
import { i as drawRect, n as drawEmbeddedImage, o as getNoteRect, r as drawImage, s as getTextObj, t as drawBackgroundRect } from "./chunk-TZMSLE5B-Br7PrtLZ.js";
import { t as ImperativeState } from "./chunk-QZHKN3VN-B03Mnwow.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-WL72ISMW.mjs
var import_dist = require_dist();
var parser = (function() {
	var o = /* @__PURE__ */ __name(function(k, v, o2, l) {
		for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v);
		return o2;
	}, "o"), $V0 = [1, 2], $V1 = [1, 3], $V2 = [1, 4], $V3 = [2, 4], $V4 = [1, 9], $V5 = [1, 11], $V6 = [1, 13], $V7 = [1, 14], $V8 = [1, 16], $V9 = [1, 17], $Va = [1, 18], $Vb = [1, 24], $Vc = [1, 25], $Vd = [1, 26], $Ve = [1, 27], $Vf = [1, 28], $Vg = [1, 29], $Vh = [1, 30], $Vi = [1, 31], $Vj = [1, 32], $Vk = [1, 33], $Vl = [1, 34], $Vm = [1, 35], $Vn = [1, 36], $Vo = [1, 37], $Vp = [1, 38], $Vq = [1, 39], $Vr = [1, 41], $Vs = [1, 42], $Vt = [1, 43], $Vu = [1, 44], $Vv = [1, 45], $Vw = [1, 46], $Vx = [
		1,
		4,
		5,
		13,
...
var styles_default = /* @__PURE__ */ __name((options) => `.actor {
...
var drawActorTypeControl = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	_drawTextCandidateFunc(conf2, hasKatex(actor.description))(actor.description, actElem, rect.x, rect.y + r + (isFooter ? 5 : 10), rect.width, rect.height, { class: `actor ${ACTOR_MAN_FIGURE_CLASS}` }, conf2);
	return actor.height;
...
var drawActorTypeEntity = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	_drawTextCandidateFunc(conf2, hasKatex(actor.description))(actor.description, actElem, rect.x, rect.y + (!isFooter ? (cy + r - actorY) / 2 : (cy - actorY + r - 5) / 2), rect.width, rect.height, { class: `actor ${ACTOR_MAN_FIGURE_CLASS}` }, conf2);
	if (!isFooter) actElem.attr("transform", `translate(0, ${r / 2})`);
	else actElem.attr("transform", `translate(0, ${r / 2})`);
	return actor.height;
}, "drawActorTypeEntity");
...
`;
	...
	if (!isFooter) cylinderGroup.attr("transform", `translate(${w * 1.5}, ${(rect.height + ry) / 4})`);
	else cylinderGroup.attr("transform", `translate(${w * 1.5}, ${rect.height / 4 - 2 * ry})`);
	actor.rectData = rect;
	_drawTextCandidateFunc(conf2, hasKatex(actor.description))(actor.description, g, rect.x, rect.y + (!isFooter ? (rect.height + ry) / 2 : (rect.height + h) / 4), rect.width, rect.height, { class: `actor ${ACTOR_BOX_CLASS}` }, conf2);
	const lastPath = cylinderGroup.select("path:last-child");
...
var drawActorTypeBoundary = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	actor.height = actElem.node().getBBox().height + (conf2.sequence.labelBoxHeight ?? 0);
	_drawTextCandidateFunc(conf2, hasKatex(actor.description))(actor.description, actElem, rect.x, rect.y + (!isFooter ? radius / 2 + 3 : radius / 2 - 4), rect.width, rect.height, { class: `actor ${ACTOR_MAN_FIGURE_CLASS}` }, conf2);
	if (!isFooter) actElem.attr("transform", `translate(0,${radius / 2 + 7})`);
	else actElem.attr("transform", `translate(0,${radius / 2 + 7})`);
	return actor.height;
...
var drawActorTypeActor = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	_drawTextCandidateFunc(conf2, hasKatex(actor.description))(actor.description, actElem, rect.x, rect.y + 35, rect.width, rect.height, { class: `actor ${ACTOR_MAN_FIGURE_CLASS}` }, conf2);
	return actor.height;
}, "drawActorTypeActor");
var drawActor = /* @__PURE__ */ __name(async function(elem, actor, conf2, isFooter) {
	switch (actor.type) {
		...
		case "boundary": return await drawActorTypeBoundary(elem, actor, conf2, isFooter);
		case "control": return await drawActorTypeControl(elem, actor, conf2, isFooter);
		case "entity": return await drawActorTypeEntity(elem, actor, conf2, isFooter);
		case "database": return await drawActorTypeDatabase(elem, actor, conf2, isFooter);
		case "collections": return await drawActorTypeCollections(elem, actor, conf2, isFooter);
		case "queue": return await drawActorTypeQueue(elem, actor, conf2, isFooter);
	}
}, "drawActor");
...
var drawMessage = /* @__PURE__ */ __name(async function(diagram2, msgModel, lineStartY, diagObj) {
	...
	const textWidth = textDims.width;
	let line;
	if (startx === stopx) if (conf.rightAngles) line = diagram2.append("path").attr("d", `M  ${startx},${lineStartY} H ${startx + common_default.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`);
	...
	if (sequenceVisible || conf.showSequenceNumbers) {
		if (type === diagObj.db.LINETYPE.BIDIRECTIONAL_SOLID || type === diagObj.db.LINETYPE.BIDIRECTIONAL_DOTTED) {
			...
			if (startx < stopx) line.attr("x1", startx + 2 * SEQUENCE_NUMBER_RADIUS);
...
var buildMessageModel = /* @__PURE__ */ __name(function(msg, actors, diagObj) {
	...
	if (msg.from === msg.to) stopx = startx;
		...
		if ([diagObj.db.LINETYPE.BIDIRECTIONAL_SOLID, diagObj.db.LINETYPE.BIDIRECTIONAL_DOTTED].includes(msg.type)) startx -= adjustValue(3);
	}
	const allBounds = [
		fromLeft,
		fromRight,
...
//# sourceMappingURL=sequenceDiagram-WL72ISMW-DXskYRse.js.map