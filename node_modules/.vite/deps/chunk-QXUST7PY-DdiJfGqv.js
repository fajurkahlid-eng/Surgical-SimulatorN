...
import { b as getConfig2, h as evaluate } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { C as catmullRom_default, D as bumpY, E as bumpX, O as linear_default, S as monotoneY, T as basis_default, _ as stepAfter, b as natural_default, h as utils_default, v as stepBefore, w as cardinal_default, x as monotoneX, y as step_default } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { t as line_default } from "./line-3eGhaofM.js";
import { n as markerOffsets, r as markerOffsets2, t as getLineFunctionsWithOffset } from "./chunk-HN2XXSSU-DQ1MW4A7.js";
...
import { n as createText } from "./chunk-JA3XYJ7Z-lb2653Mr.js";
import { d as at, r as createLabel_default } from "./chunk-JZLCHNYA-BMKl94Vp.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-QXUST7PY.mjs
var addEdgeMarkers = /* @__PURE__ */ __name((svgPath, edge, url, id, diagramType, strokeColor) => {
	if (edge.arrowTypeStart) addEdgeMarker(svgPath, "start", edge.arrowTypeStart, url, id, diagramType, strokeColor);
	if (edge.arrowTypeEnd) addEdgeMarker(svgPath, "end", edge.arrowTypeEnd, url, id, diagramType, strokeColor);
}, "addEdgeMarkers");
var arrowTypesMap = {
	arrow_cross: {
		type: "cross",
...
var addEdgeMarker = /* @__PURE__ */ __name((svgPath, position, arrowType, url, id, diagramType, strokeColor) => {
	...
	const originalMarkerId = `${id}_${diagramType}-${arrowTypeInfo.type}${position === "start" ? "Start" : "End"}`;
...
var getLabelStyles = /* @__PURE__ */ __name((styleArray) => {
	return styleArray ? styleArray.reduce((acc, style) => acc + ";" + style, "") : "";
}, "getLabelStyles");
...
//# sourceMappingURL=chunk-QXUST7PY-DdiJfGqv.js.map