import { t as package_default } from "./chunk-DR5Q36YT-BtOwqjun.js";
import { B as select_default, H as __name, U as log, W as setLogLevel } from "./src-B_PPPpSz.js";
import { J as themes_default, M as registerLazyLoadedDiagrams, P as reset, R as saveConfigFromInitialize, S as getDiagramLoader, V as setConfig, W as setSiteConfig, X as purify, Y as updateSiteConfig, c as configureSvgSize, f as detectType, g as frontMatterRegex, h as evaluate, j as registerDiagram, l as defaultConfig, n as addDirective, p as detectors, q as styles_default, r as assignWithDepth_default, t as UnknownDiagramError, w as getSiteConfig, x as getDiagram, y as getConfig } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { a as encodeEntities, d as isDetailedError, h as utils_default, i as decodeEntities, m as removeDirectives, r as cleanAndMerge } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { t as selectSvgElement } from "./chunk-EXTU4WIE-saRH4EMp.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-MI3HLSF2-DHQ3pTGf.js";
import "./chunk-HN2XXSSU-DQ1MW4A7.js";
import "./chunk-CVBHYZKI-xXVaJR-Z.js";
import "./chunk-ATLVNIR6-lQ2msyh5.js";
import { i as registerIconPacks, s as dedent } from "./chunk-JA3XYJ7Z-lb2653Mr.js";
import "./chunk-JZLCHNYA-BMKl94Vp.js";
import "./chunk-QXUST7PY-DdiJfGqv.js";
import { n as registerLayoutLoaders } from "./chunk-N4CR4FBY-yWpb9S2F.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-CriWw6W_.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-DLfek5LA.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-Dayb3mht.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-V2S2FVAM-B3c-jY0G.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-JELNMOA3-BNcsbO2o.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-HS3SLOUP-DynMWBnc.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-DD2bvH4Q.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-D6YrcD8e.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-DpM9Kmt3.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-S17eBKMS.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-DXskYRse.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-CxUMDxl7.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-xa5fdbi0.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-DqaMS__Z.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-no93-88u.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-CHsQ6fpf.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var renderer = { draw: /* @__PURE__ */ __name((_text, id28, version) => {
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-DN8th8Te.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-Dj2pOWeQ.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-BLxzCsXf.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-0wMc8aPT.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-Dd8llTAw.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-CN7gVDF5.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-DFD0qVIM.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-D7TkTxHR.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-CeSEon0r.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var loadRegisteredDiagrams = /* @__PURE__ */ __name(async () => {
	...
	const failed = (await Promise.allSettled(Object.entries(detectors).map(async ([key, { detector: detector28, loader: loader28 }]) => {
		if (!loader28) return;
		try {
			getDiagram(key);
		} catch {
...
var Diagram = class _Diagram {
	...
	static async fromText(text, metadata = {}) {
		...
		try {
			...
			if (!loader28) throw new UnknownDiagramError(`Diagram ${type} not found.`);
...
:root { --mermaid-alt-font-family: ${config.altFontFamily}}`;
	if (classDefs instanceof Map) {
		const cssElements = config.htmlLabels ?? config.flowchart?.htmlLabels ? ["> *", "span"] : [
			"rect",
			"polygon",
			"ellipse",
			"circle",
		...
		classDefs.forEach((styleClassDef) => {
			...
			if (!isEmpty(styleClassDef.textStyles)) cssStyles += cssImportantStyles(styleClassDef.id, "tspan", (styleClassDef?.textStyles || []).map((s) => s.replace("color", "fill")));
		});
	}
	return cssStyles;
}, "createCssStyles");
var createUserStyles = /* @__PURE__ */ __name((config, graphType, classDefs, svgId) => {
	return serialize(compile(`${svgId}{${styles_default(graphType, createCssStyles(config, classDefs), config.themeVariables)}}`), stringify);
}, "createUserStyles");
...
var render = /* @__PURE__ */ __name(async function(id28, text, svgContainingElement) {
	...
	try {
		...
		else errorRenderer_default.draw(text, id28, package_default.version);
		throw e;
	}
...
var runThrowsErrors = /* @__PURE__ */ __name(async function({ postRenderCallback, querySelector, nodes } = { querySelector: ".mermaid" }) {
	...
	for (const element of Array.from(nodesToProcess)) {
		...
		try {
			...
			if (postRenderCallback) await postRenderCallback(id28);
...
var mermaid = {
	...
	getRegisteredDiagramsMetadata: /* @__PURE__ */ __name(() => {
		return Object.keys(detectors).map((id28) => ({ id: id28 }));
