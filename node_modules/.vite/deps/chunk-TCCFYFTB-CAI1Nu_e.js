import { a as __toCommonJS, i as __reExport, n as __esmMin, o as __toESM, r as __exportAll, t as __commonJSMin } from "./chunk-CXA2xvMn.js";
import { H as isFunction, U as isObject, c as identity, x as isArray } from "./merge-2lX1EQ9d.js";
import { t as isEmpty } from "./isEmpty-BtAGJJtt.js";
import { A as head, C as isString, F as dropRight, G as assign, I as drop, K as keys, L as last, M as filter, N as every, O as flatMap, P as forEach, R as difference, S as values, T as groupBy, U as clone, V as compact, W as flatten, b as indexOf, h as min, i as uniq, j as find, k as map, l as reject, p as pickBy, q as noop, r as uniqBy, s as some, u as reduce, v as isUndefined, w as has, x as includes, y as isRegExp, z as defaults } from "./lodash-4hc_7jM2.js";
...
//#endregion
//#region node_modules/langium/lib/languages/generated/ast.js
/******************************************************************************
...
function isAbstractRule(item) {
	return reflection$1.isInstance(item, AbstractRule.$type);
}
var AbstractType = { $type: "AbstractType" };
function isAbstractType(item) {
	return reflection$1.isInstance(item, AbstractType.$type);
}
var Action = {
	$type: "Action",
	cardinality: "cardinality",
...
function isArrayLiteral(item) {
	return reflection$1.isInstance(item, ArrayLiteral.$type);
}
var ArrayType = {
	$type: "ArrayType",
...
function isArrayType(item) {
	return reflection$1.isInstance(item, ArrayType.$type);
}
var Assignment = {
	$type: "Assignment",
	cardinality: "cardinality",
...
function isCondition(item) {
	return reflection$1.isInstance(item, Condition.$type);
}
var Conjunction = {
	$type: "Conjunction",
	left: "left",
...
function isGrammar(item) {
	return reflection$1.isInstance(item, Grammar.$type);
}
var GrammarImport = {
	$type: "GrammarImport",
	path: "path"
...
function isGrammarImport(item) {
	return reflection$1.isInstance(item, GrammarImport.$type);
}
var Group$1 = {
	$type: "Group",
	cardinality: "cardinality",
...
function isInfixRuleOperatorList(item) {
	return reflection$1.isInstance(item, InfixRuleOperatorList.$type);
}
...
function isInfixRuleOperators(item) {
	return reflection$1.isInstance(item, InfixRuleOperators.$type);
}
var Interface = {
	$type: "Interface",
...
function isNamedArgument(item) {
	return reflection$1.isInstance(item, NamedArgument.$type);
}
var NegatedToken = {
	$type: "NegatedToken",
	cardinality: "cardinality",
...
function isNumberLiteral(item) {
	return reflection$1.isInstance(item, NumberLiteral.$type);
}
var Parameter = {
	$type: "Parameter",
	name: "name"
...
function isParameter(item) {
	return reflection$1.isInstance(item, Parameter.$type);
}
...
function isReferenceType(item) {
	return reflection$1.isInstance(item, ReferenceType.$type);
}
var RegexToken = {
	$type: "RegexToken",
	cardinality: "cardinality",
...
function isStringLiteral(item) {
	return reflection$1.isInstance(item, StringLiteral.$type);
}
...
function isTerminalElement(item) {
	return reflection$1.isInstance(item, TerminalElement.$type);
}
var TerminalGroup = {
	$type: "TerminalGroup",
	cardinality: "cardinality",
...
function isTypeAttribute(item) {
	return reflection$1.isInstance(item, TypeAttribute.$type);
}
var TypeDefinition = { $type: "TypeDefinition" };
function isTypeDefinition(item) {
	return reflection$1.isInstance(item, TypeDefinition.$type);
}
var UnionType = {
	$type: "UnionType",
	types: "types"
...
function isUnionType(item) {
	return reflection$1.isInstance(item, UnionType.$type);
}
var UnorderedGroup = {
	$type: "UnorderedGroup",
	cardinality: "cardinality",
...
function isValueLiteral(item) {
	return reflection$1.isInstance(item, ValueLiteral.$type);
}
var Wildcard = {
	$type: "Wildcard",
	cardinality: "cardinality",
	...
	constructor() {
		...
		this.types = {
			...
			Group: {
				name: Group$1.$type,
				properties: {
					cardinality: { name: Group$1.cardinality },
					elements: {
						name: Group$1.elements,
						defaultValue: []
					},
					guardCondition: { name: Group$1.guardCondition },
					predicate: { name: Group$1.predicate }
				},
				superTypes: [AbstractElement.$type]
			},
			InferredType: {
...
var reflection$1 = new LangiumGrammarAstReflection();
//#endregion
//#region node_modules/langium/lib/utils/cst-utils.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
******************************************************************************/
var cst_utils_exports = /* @__PURE__ */ __exportAll({
...
//#endregion
//#region node_modules/langium/lib/utils/errors.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
* terms of the MIT License, which is available in the project root.
******************************************************************************/
var regexp_utils_exports = /* @__PURE__ */ __exportAll({
...
//#endregion
//#region node_modules/langium/lib/utils/grammar-utils.js
/******************************************************************************
* Copyright 2021-2022 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
******************************************************************************/
var grammar_utils_exports = /* @__PURE__ */ __exportAll({
...
function getAllRulesUsedForCrossReferences(grammar) {
	...
	streamAllContents(grammar).forEach((node) => {
		if (isCrossReference(node)) {
			if (isParserRule(node.type.ref)) result.add(node.type.ref);
			if (isInferredType(node.type.ref) && isParserRule(node.type.ref.$container)) result.add(node.type.ref.$container);
		}
	});
	return result;
}
...
function getRuleTypeName(rule) {
	...
	else return isParserRule(rule) && isDataTypeRule(rule) ? rule.name : getExplicitRuleType(rule) ?? rule.name;
}
/**
...
function isOptionalProd(prod, alreadyVisited = []) {
	if (prod instanceof Option$1 || prod instanceof Repetition || prod instanceof RepetitionWithSeparator) return true;
...
function restForRepetitionWithSeparator(repSepProd, currRest, prevRest) {
	return [new Option$1({ definition: [new Terminal({ terminalType: repSepProd.separator })].concat(repSepProd.definition) })].concat(currRest, prevRest);
}
//#endregion
...
function computeAllProdsFollows(topProductions) {
	...
	forEach(topProductions, (topProd) => {
		assign(reSyncFollows, new ResyncFollowsWalker(topProd).startWalking());
	});
...
var MODES = "modes";
var SUPPORT_STICKY = typeof (/* @__PURE__ */ new RegExp("(?:)")).sticky === "boolean";
function analyzeTokenTypes(tokenTypes, options) {
	...
	if (!options.safeMode) tracer("First Char Optimization", () => {
		charCodeToPatternIdxToConfig = reduce(onlyRelevantTypes, (result, currTokType, idx) => {
			...
			} else if (isRegExp(currTokType.PATTERN)) if (currTokType.PATTERN.unicode) {
		...
		forEach(rules, (currRule) => {
			this.TRACE_INIT(`${currRule.name} Rule Lookahead`, () => {
				...
				forEach(repetition, (currProd) => {
					this.computeLookaheadFunc(currRule, currProd.idx, 768, "Repetition", currProd.maxLookahead, getProductionDslName$1(currProd));
				});
				forEach(option, (currProd) => {
					this.computeLookaheadFunc(currRule, currProd.idx, 512, "Option", currProd.maxLookahead, getProductionDslName$1(currProd));
				});
...
var RecognizerEngine = class {
	initRecognizerEngine(tokenVocabulary, config) {
		...
		else if (has(tokenVocabulary, "modes") && every(flatten(values(tokenVocabulary.modes)), isTokenType)) this.tokensMap = reduce(uniq(flatten(values(tokenVocabulary.modes))), (acc, tokType) => {
			acc[tokType.name] = tokType;
			return acc;
		}, {});
		...
		this.tokenMatcher = every(has(tokenVocabulary, "modes") ? flatten(values(tokenVocabulary.modes)) : values(tokenVocabulary), (tokenConstructor) => isEmpty(tokenConstructor.categoryMatches)) ? tokenStructuredMatcherNoCategories : tokenStructuredMatcher;
		...
		this.TRACE_INIT("performSelfAnalysis", () => {
			...
			if (isEmpty(this.definitionErrors)) {
				if (this.recoveryEnabled) this.TRACE_INIT("computeAllProdsFollows", () => {
					this.resyncFollows = computeAllProdsFollows(values(this.gastProductionsCache));
				});
...
var LangiumCompletionParser = class extends AbstractLangiumParser {
	...
	parse(input) {
		this.resetState();
		this.tokens = this.lexer.tokenize(input, { mode: "partial" }).tokens;
...
var ChevrotainWrapper = class extends EmbeddedActionsParser {
	constructor(tokens, config) {
		...
		super(tokens, {
			...defaultConfig,
			lookaheadStrategy: useDefaultLookahead ? new LLkLookaheadStrategy({ maxLookahead: config.maxLookahead }) : new LLStarLookaheadStrategy({ logging: config.skipValidations ? () => {} : void 0 }),
			...config
		});
	}
	get IS_RECORDING() {
...
//#endregion
//#region node_modules/langium/lib/utils/cancellation.js
...
var { URI, Utils } = LIB;
//#endregion
//#region node_modules/langium/lib/utils/uri-utils.js
/******************************************************************************
* Copyright 2022 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/references/linker.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
	...
	buildReference(node, property, refNode, refText) {
		...
		const reference = {
			...
			get ref() {
				...
				else if (isAstNodeDescription(this._nodeDescription)) this._ref = linker.loadAstNode(this._nodeDescription) ?? linker.createLinkingError({
					reference,
					container: node,
					property
...
//#endregion
//#region node_modules/langium/lib/references/name-provider.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/references/references.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/utils/collections.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/references/scope-computation.js
/******************************************************************************
* Copyright 2021-2022 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/references/scope.js
/******************************************************************************
...
var MapScope = class {
	...
	getElements(name) {
		...
		if ((this.concatOuterScope || arr.length > 0) && this.outerScope) return stream(arr).concat(this.outerScope.getElements(name));
		else return stream(arr);
	}
	getAllElements() {
...
//#endregion
//#region node_modules/langium/lib/utils/caching.js
/******************************************************************************
* Copyright 2023 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/references/scope-provider.js
/******************************************************************************
* Copyright 2021-2022 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/validation/validation-registry.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/validation/document-validator.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/workspace/ast-descriptions.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/utils/event.js
...
//#endregion
//#region node_modules/langium/lib/utils/disposable.js
/******************************************************************************
* Copyright 2021 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
var DefaultLexer = class {
	constructor(services) {
		...
		this.chevrotainLexer = new Lexer(isTokenTypeDictionary(tokens) ? Object.values(tokens) : tokens, {
			positionTracking: "full",
			skipValidations: services.LanguageMetaData.mode === "production",
...
//#endregion
//#region node_modules/langium/lib/parser/indentation-aware.js
/******************************************************************************
* Copyright 2024 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
var IndentationAwareTokenBuilder = class extends DefaultTokenBuilder {
	...
	buildTokens(grammar, options) {
		...
		if (ignoreIndentationDelimiters.length > 0) return {
			modes: {
				[LexingMode.REGULAR]: [
					dedent,
					indent,
...
var IndentationAwareLexer = class extends DefaultLexer {
	...
	tokenize(text, options = DEFAULT_TOKENIZE_OPTIONS) {
		...
		if (options?.mode === "full") result.tokens.push(...report.remainingDedents);
...
//#endregion
//#region node_modules/langium/lib/utils/grammar-loader.js
/******************************************************************************
* Copyright 2023 TypeFox GmbH
* This program and the accompanying materials are made available under the
* terms of the MIT License, which is available in the project root.
...
//#endregion
//#region node_modules/langium/lib/utils/index.js
...
//#endregion
//#region node_modules/langium/lib/workspace/profiler.js
/******************************************************************************
...
var DefaultLangiumProfiler = class {
	...
	start(...categories) {
		if (!categories) this.activeCategories = new Set(this.allCategories);
		else categories.forEach((category) => this.activeCategories.add(category));
	}
	stop(...categories) {
		if (!categories) this.activeCategories.clear();
		else categories.forEach((category) => this.activeCategories.delete(category));
	}
	createTask(category, taskId) {
		if (!this.isActive(category)) throw new Error(`Category "${category}" is not active.`);
	...
	dumpRecord(category, record) {
		...
		console.table(result.map((e) => {
			return {
				Element: e.name,
				Count: e.count,
				"Self %": Round(100 * e.duration / record.duration),
				"Time (ms)": Round(e.duration)
			};
		}));
		return record;
	}
	getRecords(...categories) {
		if (categories.length === 0) return this.records.values();
		else return this.records.entries().filter((e) => categories.some((c) => c === e[0])).flatMap((e) => e[1]);
	}
};
var ProfilingTask = class {
	...
	stop() {
		...
		if (this.stack.length !== 0) throw new Error(`Task "${this.identifier}" cannot be stopped before sub-task(s): ${this.stack.map((s) => s.id).join(", ")}.`);
		const record = {
	...
	stopSubTask(subTaskId) {
		...
		if (!subStack) throw new Error(`Task "${this.identifier}.${subTaskId}" was not started.`);
		if (subStack.id !== subTaskId) throw new Error(`Sub-Task "${subStack.id}" is not already stopped.`);
		const duration = performance.now() - subStack.start;
		if (this.stack.at(-1) !== void 0) this.stack[this.stack.length - 1].content += duration;
...
//#endregion
//#region node_modules/@mermaid-js/parser/dist/chunks/mermaid-parser.core/chunk-TCCFYFTB.mjs
...
//#endregion
export { GitGraphGrammarGeneratedModule as a, PacketGrammarGeneratedModule as c, TreemapGrammarGeneratedModule as d, __name as f, createDefaultSharedCoreModule as g, createDefaultCoreModule as h, CommonValueConverter as i, PieGrammarGeneratedModule as l, inject as m, AbstractMermaidValueConverter as n, InfoGrammarGeneratedModule as o, EmptyFileSystem as p, ArchitectureGrammarGeneratedModule as r, MermaidGeneratedSharedModule as s, AbstractMermaidTokenBuilder as t, RadarGrammarGeneratedModule as u };

//# sourceMappingURL=chunk-TCCFYFTB-CAI1Nu_e.js.map