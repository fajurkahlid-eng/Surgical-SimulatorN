...
import { B as setAccTitle, C as getDiagramTitle, G as setupGraphViewbox, I as sanitizeText, U as setDiagramTitle, _ as getAccDescription, a as clear, b as getConfig2, d as defaultConfig_default, v as getAccTitle, y as getConfig, z as setAccDescription } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { r as cleanAndMerge, s as getEdgeId } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { t as selectSvgElement } from "./chunk-EXTU4WIE-saRH4EMp.js";
import { i as registerIconPacks, n as createText, o as unknownIcon, r as getIconSVG } from "./chunk-JA3XYJ7Z-lb2653Mr.js";
import { t as populateCommonDb } from "./chunk-4BX2VUAB-DFWsJGts.js";
import { t as parse } from "./mermaid-parser.core-BqZ5K2zK.js";
import { t as cytoscape$1 } from "./cytoscape.esm-C192XRb1.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-VXUJARFQ.mjs
...
var drawJunctions = /* @__PURE__ */ __name(function(db, elem, junctions) {
	junctions.forEach((junction) => {
		...
		const iconSize = db.getConfigField("iconSize");
		junctionElem.append("g").append("rect").attr("id", "node-" + junction.id).attr("fill-opacity", "0").attr("width", iconSize).attr("height", iconSize);
...
function getAlignments(db, spatialMaps, groupAlignments) {
	...
	const [horizontal, vertical] = spatialMaps.map((spatialMap) => {
	...
	return new Promise((resolve) => {
		...
		const layout = cy.layout({
			...
			idealEdgeLength(edge) {
				...
				return parentA === parentB ? 1.5 * db.getConfigField("iconSize") : .5 * db.getConfigField("iconSize");
			},
			edgeElasticity(edge) {
				const [nodeA, nodeB] = edge.connectedNodes();
				const { parent: parentA } = nodeData(nodeA);
				const { parent: parentB } = nodeData(nodeB);
				return parentA === parentB ? .45 : .001;
			},
			alignmentConstraint,
...
//# sourceMappingURL=architectureDiagram-VXUJARFQ-D7TkTxHR.js.map