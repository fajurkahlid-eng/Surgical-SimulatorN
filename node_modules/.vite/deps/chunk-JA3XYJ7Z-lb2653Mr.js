...
import { I as sanitizeText, N as renderKatexSanitized, O as hasKatex, s as common_default, y as getConfig } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { i as decodeEntities } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-JA3XYJ7Z.mjs
var unknownIcon = {
...
function preprocessMarkdown(markdown, { markdownAutoWrap }) {
	...
	if (markdownAutoWrap === false) return withoutExtraSpaces.replace(/ /g, "&nbsp;");
...
var createText = /* @__PURE__ */ __name(async (el, text = "", { style = "", isTitle = false, classes = "", useHtmlLabels = true, isNode = true, width = 200, addSvgBackground = false } = {}, config) => {
	log.debug("XYZ createText", text, style, isTitle, classes, useHtmlLabels, isNode, "addSvgBackground: ", addSvgBackground);
	if (useHtmlLabels) {
		const decodedReplacedText = await replaceIconSubstring(decodeEntities(markdownToHTML(text, config)), config);
		...
		const svgLabel = createFormattedText(width, el, markdownToLines(text.replace(/<br\s*\/?>/g, "<br/>").replace("<br>", "<br/>"), config), text ? addSvgBackground : false);
		if (isNode) {
...
//# sourceMappingURL=chunk-JA3XYJ7Z-lb2653Mr.js.map