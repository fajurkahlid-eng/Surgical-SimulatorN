...
import { E as getUrl, I as sanitizeText, a as clear, b as getConfig2, c as configureSvgSize, et as rgba, h as evaluate, s as common_default, y as getConfig } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { t as channel } from "./channel-D1ZP0Shw.js";
import { T as basis_default, c as getStylesFromArray, h as utils_default, i as decodeEntities } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { t as line_default } from "./line-3eGhaofM.js";
import { t as getLineFunctionsWithOffset } from "./chunk-HN2XXSSU-DQ1MW4A7.js";
import { t as getSubGraphTitleMargins } from "./chunk-CVBHYZKI-xXVaJR-Z.js";
import { a as replaceIconSubstring, n as createText } from "./chunk-JA3XYJ7Z-lb2653Mr.js";
import { U as clone } from "./lodash-4hc_7jM2.js";
import { t as getIconStyles } from "./chunk-FMBD7UC4-BZCqNI88.js";
import { t as Graph } from "./graphlib-sE1AREj6.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/blockDiagram-VD42YOAC.mjs
var parser = (function() {
...
var createLabel_default = /* @__PURE__ */ __name(async (_vertexText, style, isTitle, isNode) => {
	...
	if (evaluate(config2.flowchart.htmlLabels)) {
		...
		return addHtmlLabel({
			isNode,
			label: await replaceIconSubstring(decodeEntities(vertexText)),
...
var positionEdgeLabel = /* @__PURE__ */ __name((edge, paths) => {
	...
	const { subGraphTitleTotalMargin } = getSubGraphTitleMargins(getConfig2());
	if (edge.label) {
...
var labelHelper = /* @__PURE__ */ __name(async (parent, node, _classes, isNode) => {
	...
	let text;
	if (node.labelType === "markdown") text = createText(label, sanitizeText(decodeEntities(labelText), config2), {
		useHtmlLabels,
		width: node.width || config2.flowchart.wrappingWidth,
		classes: "markdown-node-label"
	}, config2);
	else text = textNode.appendChild(await createLabel_default(sanitizeText(decodeEntities(labelText), config2), node.labelStyle, false, isNode));
...
var note_default = /* @__PURE__ */ __name(async (parent, node) => {
	if (!(node.useHtmlLabels || getConfig2().flowchart.htmlLabels)) node.centerLabel = true;
...
var shapes = {
	...
	class_box: /* @__PURE__ */ __name(async (parent, node) => {
		...
		if (node.classData.type !== void 0 && node.classData.type !== "") if (getConfig2().flowchart.htmlLabels) classTitleString += "&lt;" + node.classData.type + "&gt;";
		...
		node.classData.members.forEach(async (member) => {
			...
			if (getConfig2().flowchart.htmlLabels) parsedText = parsedText.replace(/</g, "&lt;").replace(/>/g, "&gt;");
		...
		node.classData.methods.forEach(async (member) => {
			...
			if (getConfig2().flowchart.htmlLabels) displayText = displayText.replace(/</g, "&lt;").replace(/>/g, "&gt;");
...
var positionNode = /* @__PURE__ */ __name((node) => {
	...
	if (node.clusterNode) el.attr("transform", "translate(" + (node.x + diff - node.width / 2) + ", " + (node.y - node.height / 2 - padding2) + ")");
...
//# sourceMappingURL=blockDiagram-VD42YOAC-DFD0qVIM.js.map