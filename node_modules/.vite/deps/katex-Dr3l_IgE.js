...
var toMarkup = function toMarkup(tagName) {
	...
	var styles = "";
	for (var style in this.style) if (this.style.hasOwnProperty(style)) styles += hyphenate(style) + ":" + this.style[style] + ";";
...
var SvgNode = class {
	...
	toMarkup() {
		...
		for (var attr in this.attributes) if (Object.prototype.hasOwnProperty.call(this.attributes, attr)) markup += " " + attr + "=\"" + escape(this.attributes[attr]) + "\"";
		markup += ">";
		for (var i = 0; i < this.children.length; i++) markup += this.children[i].toMarkup();
		markup += "</svg>";
		return markup;
...
var htmlBuilder$6 = function htmlBuilder(group, options) {
	...
	if (tagSpans.length === 0) return makeSpan(["mord"], [body], options);
	else {
...
//# sourceMappingURL=katex-Dr3l_IgE.js.map