import { B as select_default, H as __name, T as format, U as log } from "./src-B_PPPpSz.js";
import { B as setAccTitle, C as getDiagramTitle, U as setDiagramTitle, _ as getAccDescription, a as clear, c as configureSvgSize, d as defaultConfig_default, v as getAccTitle, y as getConfig, z as setAccDescription } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { t as ordinal } from "./ordinal-Im3xuT1t.js";
import { r as cleanAndMerge } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
import { t as selectSvgElement } from "./chunk-EXTU4WIE-saRH4EMp.js";
import { i as styles2String, n as isLabelStyle } from "./chunk-ATLVNIR6-lQ2msyh5.js";
import { t as populateCommonDb } from "./chunk-4BX2VUAB-DFWsJGts.js";
import { t as parse } from "./mermaid-parser.core-BqZ5K2zK.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/diagram-PSM6KHXK.mjs
var TreeMapDB = class {
	constructor() {
		this.nodes = [];
...
var renderer = {
	draw: /* @__PURE__ */ __name((_text, id, _version, diagram2) => {
		...
		cell.append("text").attr("class", "treemapLabel").attr("x", (d) => (d.x1 - d.x0) / 2).attr("y", (d) => (d.y1 - d.y0) / 2).attr("style", (d) => {
			return "text-anchor: middle; dominant-baseline: middle; font-size: 38px;fill:" + colorScaleLabel(d.data.name) + ";" + styles2String({ cssCompiledStyles: d.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:");
			...
			self.style("font-size", `${currentLabelFontSize}px`);
			if (textNode.getComputedTextLength() > availableWidth || currentLabelFontSize < minLabelFontSize || availableHeight < currentLabelFontSize) self.style("display", "none");
		});
		if (config.showValues !== false) cell.append("text").attr("class", "treemapValue").attr("x", (d) => (d.x1 - d.x0) / 2).attr("y", function(d) {
			return (d.y1 - d.y0) / 2;
		}).attr("style", (d) => {
			return "text-anchor: middle; dominant-baseline: hanging; font-size: 28px;fill:" + colorScaleLabel(d.data.name) + ";" + styles2String({ cssCompiledStyles: d.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:");
			...
			const availableWidthForValue = nodeWidth - 8;
...
//# sourceMappingURL=diagram-PSM6KHXK-CeSEon0r.js.map