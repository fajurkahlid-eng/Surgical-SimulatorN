import { o as __toESM, t as __commonJSMin } from "./chunk-CXA2xvMn.js";
import { B as select_default, F as Rgb, G as require_dayjs_min, H as __name, L as rgbConvert, M as nogamma, P as Color, R as define_default, U as log, _ as durationMonth, a as timeMonday, b as durationYear, c as timeThursday, d as utcSunday, f as timeDay, g as durationMinute, h as durationHour, i as timeFriday, j as hue, l as timeTuesday, m as durationDay, n as timeYear, o as timeSaturday, p as unixDay, r as utcYear, s as timeSunday, t as timeFormat, u as timeWednesday, v as durationSecond, x as timeInterval, y as durationWeek, z as extend } from "./src-B_PPPpSz.js";
import { B as setAccTitle, C as getDiagramTitle, U as setDiagramTitle, _ as getAccDescription, a as clear, b as getConfig2, c as configureSvgSize, s as common_default, v as getAccTitle, z as setAccDescription } from "./chunk-ABZYJK2D-CyNHkCnc.js";
import { a as bisector, i as tickStep, n as continuous, r as copy, t as linear } from "./linear-cK3aBK-C.js";
import { t as initRange } from "./init-CSjHPjR-.js";
import { h as utils_default } from "./chunk-S3R3BYOJ-BUKoiu6c.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/ganttDiagram-JELNMOA3.mjs
		...
		draw: /* @__PURE__ */ __name(function(text, id, version, diagObj) {
			...
			function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
				...
				rectangles.append("rect").attr("id", function(d) {
					...
					if (d.vert) return taskArray.length * (conf.barHeight + conf.barGap) + conf.barHeight * 2;
					return theBarHeight;
				...
				rectangles.append("text").attr("id", function(d) {
					...
					if (d.vert) return conf.gridLineStartPadding + taskArray.length * (conf.barHeight + conf.barGap) + 60;
					i = d.order;
			...
			function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
				...
				svg.append("g").selectAll("rect").data(excludeRanges).enter().append("rect").attr("id", (d2) => "exclude-" + d2.start.format("YYYY-MM-DD")).attr("x", (d2) => timeScale(d2.start.startOf("day")) + theSidePad).attr("y", conf.gridLineStartPadding).attr("width", (d2) => timeScale(d2.end.endOf("day")) - timeScale(d2.start.startOf("day"))).attr("height", h2 - theTopPad - conf.gridLineStartPadding).attr("transform-origin", function(d2, i) {
...
//# sourceMappingURL=ganttDiagram-JELNMOA3-BNcsbO2o.js.map